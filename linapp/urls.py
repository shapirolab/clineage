...
urlpatterns = patterns('',
    ...
    url(r'^csv_view/partner_name:(?P<partner_name>\w+)/palette_name:(?P<palette_name>\w+)$', 'linapp.views.partner_cells_table_view'),
    ...
    url(r'^html_view/partner_name:(?P<partner_name>\w+)/palette_name:(?P<palette_name>\w+)$', 'linapp.views.partner_cells_html_view'),
