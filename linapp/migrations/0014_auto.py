...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field partner on 'TargetEnrichment'
        m2m_table_name = db.shorten_name(u'linapp_targetenrichment_partner')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('targetenrichment', models.ForeignKey(orm[u'linapp.targetenrichment'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['targetenrichment_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field partner on 'TargetEnrichment'
        db.delete_table(db.shorten_name(u'linapp_targetenrichment_partner'))
