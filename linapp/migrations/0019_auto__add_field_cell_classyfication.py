...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cell.classification'
        db.add_column(u'linapp_cell', 'classification',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cell.classification'
        db.delete_column(u'linapp_cell', 'classification')
