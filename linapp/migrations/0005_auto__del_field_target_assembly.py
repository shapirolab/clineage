...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Target.assembly'
        db.delete_column(u'linapp_target', 'assembly_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Target.assembly'
        raise RuntimeError("Cannot reverse this migration. 'Target.assembly' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Target.assembly'
        db.add_column(u'linapp_target', 'assembly',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.Assembly']),
                      keep_default=False)
