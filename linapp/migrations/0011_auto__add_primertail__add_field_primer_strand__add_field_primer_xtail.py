...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Primer.strand'
        db.add_column(u'linapp_primer', 'strand',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'Primer.xtail'
        db.add_column(u'linapp_primer', 'xtail',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.PrimerTail'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Primer.strand'
        db.delete_column(u'linapp_primer', 'strand')

        # Deleting field 'Primer.xtail'
        db.delete_column(u'linapp_primer', 'xtail_id')
