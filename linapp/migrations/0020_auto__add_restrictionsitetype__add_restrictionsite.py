...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RestrictionSiteType'
        db.create_table(u'linapp_restrictionsitetype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'linapp', ['RestrictionSiteType'])

        # Adding model 'RestrictionSite'
        db.create_table(u'linapp_restrictionsite', (
            (u'target_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['linapp.Target'], unique=True, primary_key=True)),
            ('restriction_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.RestrictionSiteType'])),
        ))
        db.send_create_signal(u'linapp', ['RestrictionSite'])


    def backwards(self, orm):
        # Deleting model 'RestrictionSiteType'
        db.delete_table(u'linapp_restrictionsitetype')

        # Deleting model 'RestrictionSite'
        db.delete_table(u'linapp_restrictionsite')
