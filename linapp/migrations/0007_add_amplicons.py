...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for te in orm.TargetEnrichment.objects.filter(amplicon=None):
            chro = Chromosome.objects.get(pk = te.chromosome.pk)
            te.amplicon = chro.getdna(te.left.start_pos, te.right.end_pos)
            te.save()
    ...
    models = {
        ...
        u'linapp.targetenrichment': {
            ...
            'amplicon': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
            'chromosome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.Chromosome']"}),
