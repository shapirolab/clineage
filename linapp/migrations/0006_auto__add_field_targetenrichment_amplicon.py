...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetEnrichment.amplicon'
        db.add_column(u'linapp_targetenrichment', 'amplicon',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetEnrichment.amplicon'
        db.delete_column(u'linapp_targetenrichment', 'amplicon')
