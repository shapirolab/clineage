...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Target', fields ['start_pos']
        db.create_index(u'linapp_target', ['start_pos'])

        # Adding index on 'Target', fields ['end_pos']
        db.create_index(u'linapp_target', ['end_pos'])


    def backwards(self, orm):
        # Removing index on 'Target', fields ['end_pos']
        db.delete_index(u'linapp_target', ['end_pos'])

        # Removing index on 'Target', fields ['start_pos']
        db.delete_index(u'linapp_target', ['start_pos'])
    ...
    models = {
        ...
        u'linapp.targetenrichment': {
            ...
            'targets_analyzed_by_phobos': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
