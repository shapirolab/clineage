...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chromosome.sequence'
        db.alter_column(u'linapp_chromosome', 'sequence_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.Sequence'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Chromosome.sequence'
        raise RuntimeError("Cannot reverse this migration. 'Chromosome.sequence' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Chromosome.sequence'
        db.alter_column(u'linapp_chromosome', 'sequence_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.Sequence']))
    ...
    models = {
        ...
        u'linapp.chromosome': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'sequence': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.Sequence']", 'null': 'True'}),
