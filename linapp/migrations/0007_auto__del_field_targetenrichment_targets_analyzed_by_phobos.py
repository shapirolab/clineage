...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TargetEnrichment.targets_analyzed_by_phobos'
        db.delete_column(u'linapp_targetenrichment', 'targets_analyzed_by_phobos')


    def backwards(self, orm):
        # Adding field 'TargetEnrichment.targets_analyzed_by_phobos'
        db.add_column(u'linapp_targetenrichment', 'targets_analyzed_by_phobos',
