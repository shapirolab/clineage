...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TargetEnrichment.amplicon'
        db.alter_column(u'linapp_targetenrichment', 'amplicon', self.gf('django.db.models.fields.CharField')(default='', max_length=500))

    def backwards(self, orm):

        # Changing field 'TargetEnrichment.amplicon'
        db.alter_column(u'linapp_targetenrichment', 'amplicon', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
