...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming field 'Microsatellite.xrepeat_number'
        db.rename_column('linapp_microsatellite', 'xrepeat_number', 'repeat_number')

    def backwards(self, orm):
        # renaming field 'Microsatellite.repeat_number'
        db.rename_column('linapp_microsatellite', 'repeat_number', 'xrepeat_number')
    ...
    models = {
        ...
        u'linapp.microsatellite': {
            ...
            'repeat_number': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '1'}),
