...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Taxa.friendly_name'
        db.add_column(u'linapp_taxa', 'friendly_name',
                      self.gf('django.db.models.fields.CharField')(default='bla', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Taxa.friendly_name'
        db.delete_column(u'linapp_taxa', 'friendly_name')
