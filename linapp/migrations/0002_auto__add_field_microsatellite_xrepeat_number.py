...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Microsatellite.xrepeat_number'
        db.add_column(u'linapp_microsatellite', 'xrepeat_number',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Microsatellite.xrepeat_number'
        db.delete_column(u'linapp_microsatellite', 'xrepeat_number')
