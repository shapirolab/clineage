...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SNP'
        db.create_table(u'linapp_snp', (
            (u'target_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['linapp.Target'], unique=True, primary_key=True)),
            ('mutation', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('modified', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'linapp', ['SNP'])


    def backwards(self, orm):
        # Deleting model 'SNP'
        db.delete_table(u'linapp_snp')
