...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RestrictionSiteType.sequence'
        db.add_column(u'linapp_restrictionsitetype', 'sequence',
                      self.gf('django.db.models.fields.CharField')(default='TTAA', max_length=50),
                      keep_default=False)

        # Adding field 'RestrictionSiteType.cut_delta'
        db.add_column(u'linapp_restrictionsitetype', 'cut_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'RestrictionSiteType.sticky_bases'
        db.add_column(u'linapp_restrictionsitetype', 'sticky_bases',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RestrictionSiteType.sequence'
        db.delete_column(u'linapp_restrictionsitetype', 'sequence')

        # Deleting field 'RestrictionSiteType.cut_delta'
        db.delete_column(u'linapp_restrictionsitetype', 'cut_delta')

        # Deleting field 'RestrictionSiteType.sticky_bases'
        db.delete_column(u'linapp_restrictionsitetype', 'sticky_bases')
    ...
    models = {
        ...
        u'linapp.cell': {
            ...
            'classification': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'sampling': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.SamplingEvent']", 'null': 'True'}),
        ...
        u'linapp.chromosome': {
            ...
            'cyclic': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'linapp.individual': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.Location']", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'partner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        u'linapp.microsatellite': {
            ...
            'repeat_number': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '1'}),
            'repeat_unit_len': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'repeat_unit_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'linapp.restrictionsite': {
            'Meta': {'object_name': 'RestrictionSite', '_ormbases': [u'linapp.Target']},
            'restriction_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.RestrictionSiteType']"}),
            u'target_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['linapp.Target']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'linapp.restrictionsitetype': {
            'Meta': {'object_name': 'RestrictionSiteType'},
            'cut_delta': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'sequence': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'sticky_bases': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'linapp.samplelocation': {
            'Meta': {'object_name': 'SampleLocation', 'index_together': "[['content_type', 'object_id']]"},
            ...
            'well': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '3', 'blank': 'True'})
        },
        ...
        u'linapp.snp': {
            'Meta': {'object_name': 'SNP', '_ormbases': [u'linapp.Target']},
            'modified': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'mutation': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            u'target_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['linapp.Target']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'linapp.storagebox': {
        ...
        u'linapp.target': {
            ...
            'end_pos': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'partner': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'null': 'True', 'symmetrical': 'False'}),
            'referencevalue': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linapp.Sequence']"}),
            'start_pos': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
        ...
        u'linapp.targetenrichment': {
            ...
            'targets': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'primer_pair'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['linapp.Target']"}),
        ...
        u'linapp.userreport': {
            ...
            'cells': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['linapp.Cell']", 'symmetrical': 'False'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'individual': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['linapp.Individual']", 'null': 'True', 'symmetrical': 'False'}),
            'partner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'})
        }
    }
