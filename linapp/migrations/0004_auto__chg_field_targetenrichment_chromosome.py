...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TargetEnrichment.chromosome'
        db.alter_column(u'linapp_targetenrichment', 'chromosome_id', self.gf('django.db.models.fields.related.ForeignKey')(default=7, to=orm['linapp.Chromosome']))

    def backwards(self, orm):

        # Changing field 'TargetEnrichment.chromosome'
        db.alter_column(u'linapp_targetenrichment', 'chromosome_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.Chromosome'], null=True))
