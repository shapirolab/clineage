...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'linapp_userreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'linapp', ['UserReport'])

        # Adding M2M table for field cells on 'UserReport'
        m2m_table_name = db.shorten_name(u'linapp_userreport_cells')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userreport', models.ForeignKey(orm[u'linapp.userreport'], null=False)),
            ('cell', models.ForeignKey(orm[u'linapp.cell'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userreport_id', 'cell_id'])

        # Adding M2M table for field individual on 'UserReport'
        m2m_table_name = db.shorten_name(u'linapp_userreport_individual')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userreport', models.ForeignKey(orm[u'linapp.userreport'], null=False)),
            ('individual', models.ForeignKey(orm[u'linapp.individual'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userreport_id', 'individual_id'])


    def backwards(self, orm):
        # Deleting model 'UserReport'
        db.delete_table(u'linapp_userreport')

        # Removing M2M table for field cells on 'UserReport'
        db.delete_table(db.shorten_name(u'linapp_userreport_cells'))

        # Removing M2M table for field individual on 'UserReport'
        db.delete_table(db.shorten_name(u'linapp_userreport_individual'))
