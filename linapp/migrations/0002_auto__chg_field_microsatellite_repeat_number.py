...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Microsatellite.repeat_number'
        db.alter_column(u'linapp_microsatellite', 'repeat_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=1))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Microsatellite.repeat_number'
        raise RuntimeError("Cannot reverse this migration. 'Microsatellite.repeat_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Microsatellite.repeat_number'
        db.alter_column(u'linapp_microsatellite', 'repeat_number', self.gf('django.db.models.fields.PositiveIntegerField')())
