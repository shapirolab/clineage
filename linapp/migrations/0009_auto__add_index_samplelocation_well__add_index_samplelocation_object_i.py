...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SampleLocation', fields ['well']
        db.create_index(u'linapp_samplelocation', ['well'])

        # Adding index on 'SampleLocation', fields ['object_id']
        db.create_index(u'linapp_samplelocation', ['object_id'])


    def backwards(self, orm):
        # Removing index on 'SampleLocation', fields ['object_id']
        db.delete_index(u'linapp_samplelocation', ['object_id'])

        # Removing index on 'SampleLocation', fields ['well']
        db.delete_index(u'linapp_samplelocation', ['well'])
