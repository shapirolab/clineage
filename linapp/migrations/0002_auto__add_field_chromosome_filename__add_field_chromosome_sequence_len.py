...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chromosome.sequence_length'
        db.add_column(u'linapp_chromosome', 'sequence_length',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chromosome.sequence_length'
        db.delete_column(u'linapp_chromosome', 'sequence_length')
