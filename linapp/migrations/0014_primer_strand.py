...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for te in orm.TargetEnrichment.objects.filter(left__strand=None):
            pl = te.left
            pl.strand = '+'
            pl.save()
            pr = te.right
            pr.strand = '-'
            pr.save()
        for te in orm.TargetEnrichment.objects.filter(right__strand=None):
            pl = te.left
            pl.strand = '+'
            pl.save()
            pr = te.right
    ...
    def backwards(self, orm):
        ...
        for te in orm.TargetEnrichment.objects.filter(right__strand__isnull=False):
            pl = te.left
            pl.strand = None
            pl.save()
            pr = te.right
