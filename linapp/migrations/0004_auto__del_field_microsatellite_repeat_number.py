...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Microsatellite.repeat_number'
        db.delete_column(u'linapp_microsatellite', 'repeat_number')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Microsatellite.repeat_number'
        db.add_column(u'linapp_microsatellite', 'repeat_number',
    ...
    models = {
        ...
        u'linapp.microsatellite': {
            ...
            'xrepeat_number': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '1'})
        },
        u'linapp.organ': {
