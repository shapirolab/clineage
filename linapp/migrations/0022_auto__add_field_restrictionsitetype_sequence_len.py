...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RestrictionSiteType.sequence_len'
        db.add_column(u'linapp_restrictionsitetype', 'sequence_len',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RestrictionSiteType.sequence_len'
        db.delete_column(u'linapp_restrictionsitetype', 'sequence_len')
    ...
    models = {
        ...
        u'linapp.restrictionsitetype': {
            ...
            'sequence_len': ('django.db.models.fields.PositiveIntegerField', [], {}),
