...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for ms in orm.Microsatellite.objects.filter(xrepeat_number__isnull=True):
            ms.xrepeat_number = ms.repeat_number
            ms.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for ms in orm.Microsatellite.objects.filter(xrepeat_number__isnull=False):
            ms.xrepeat_number = None
            ms.save()
