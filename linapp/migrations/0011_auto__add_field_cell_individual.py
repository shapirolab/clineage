...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cell.individual'
        db.add_column(u'linapp_cell', 'individual',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['linapp.Individual']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cell.individual'
        db.delete_column(u'linapp_cell', 'individual_id')
