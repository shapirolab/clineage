...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field partner on 'Target'
        m2m_table_name = db.shorten_name(u'linapp_target_partner')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('target', models.ForeignKey(orm[u'linapp.target'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['target_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field partner on 'Target'
        db.delete_table(db.shorten_name(u'linapp_target_partner'))
