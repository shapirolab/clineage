...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cell.sampling'
        db.alter_column(u'linapp_cell', 'sampling_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.SamplingEvent'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Cell.sampling'
        raise RuntimeError("Cannot reverse this migration. 'Cell.sampling' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Cell.sampling'
        db.alter_column(u'linapp_cell', 'sampling_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.SamplingEvent']))
