...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SampleLocation', fields ['content_type', 'object_id']
        db.create_index(u'linapp_samplelocation', ['content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing index on 'SampleLocation', fields ['content_type', 'object_id']
        db.delete_index(u'linapp_samplelocation', ['content_type_id', 'object_id'])
