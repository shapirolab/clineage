...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # rename field 'Microsatellite.repeat_type'
        db.rename_column(u'linapp_microsatellite', 'repeat_unit', 'repeat_unit_type')

    def backwards(self, orm):

        # rename field 'Microsatellite.repeat_unit_len'
        db.rename_column(u'linapp_microsatellite', 'repeat_unit_type', 'repeat_unit')
