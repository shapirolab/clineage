...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chromosome.sequence'
        db.delete_column(u'linapp_chromosome', 'sequence_id')


    def backwards(self, orm):
        # Adding field 'Chromosome.sequence'
        db.add_column(u'linapp_chromosome', 'sequence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linapp.Sequence'], null=True),
                      keep_default=False)
