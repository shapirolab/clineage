...
def get_hists_pairs_by_len(hist_per_length_per_cycle, lengths=[5, 10, 15, 20, 25, 30]):
    hist_pairs = []
    for ms_len in lengths:
...
def get_hists_pairs(filename='hist_by_ms_len_as_0_sum.tab', normalize=False, nsamples=None, trunc=False, cut_peak=False, lengths=[5, 10, 15, 20, 25, 30]):
...
def get_transposed_hists_pairs(filename='hist_by_ms_len_as_0_sum.tab', normalize=False, nsamples=None, trunc=False, cut_peak=False, lengths=[5, 10, 15, 20, 25, 30]):
    hist_per_length_per_cycle = read_synthetic_data_raw(filename=filename)
    hist_object_per_length_per_cycle = to_hist_objects(hist_per_length_per_cycle, normalize=normalize, nsamples=nsamples, trunc=trunc, cut_peak=cut_peak)
